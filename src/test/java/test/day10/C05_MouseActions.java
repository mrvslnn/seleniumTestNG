...
//            //4- Acilan sayfada “Your Lists” yazisi oldugunu test edelim
            WebElement yourListYazisıVarmı= driver.findElement(By.xpath("//li[@class='a-tab-heading a-active a-size-large']"));
            Assert.assertTrue(yourListYazisıVarmı.isEnabled());
        }
