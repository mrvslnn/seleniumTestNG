...
import java.util.Set;
    public class C03_MouseActions extends TestBase {
        //herbir mouseaction icin ayrı methos olusturmak ock zahmetli oalcgına
        //actions class kullanmalıyız
        //Mouse Base Actions : context click (sag klik), drag and drop (surukle birak), click and hold (tikla ve
        //bekle), double click, move to element (Webelement’e git)
        //heraket ettirme mouseactıons pageup pagedown
        //3adoma ihtiyc var
        //actıon classından parametresi driver olan obje olustur
        //hangi vebelement uzride islem yapacaksak locate et
        //bu webelement ie actions calasstan istedgimiz kadar method kullanabilirz
        //baslangıca actıons yazııp contextclick.perform
        //performyazmasak islem gerceklesmez
